...
class QueryRequestCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ExecutionResultCreateNestedManyWithoutQueryRequestsInput,
  })
  @ValidateNested()
  @Type(() => ExecutionResultCreateNestedManyWithoutQueryRequestsInput)
  @IsOptional()
  @Field(() => ExecutionResultCreateNestedManyWithoutQueryRequestsInput, {
    nullable: true,
  })
...
export { QueryRequestCreateInput as QueryRequestCreateInput };
